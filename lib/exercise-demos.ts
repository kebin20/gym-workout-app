...
const aliases: readonly [string, string][] = [
  ...
  ['dumbbell bench', 'Machine Chest Press or Dumbbell Bench'],
  ...
  ['dumbbell overhead press', 'Machine or Dumbbell Shoulder Press'],
  ...
  ['machine curl', 'Dumbbell or Cable Biceps Curl'],
  ['ez-bar', 'Dumbbell or Cable Biceps Curl'],
