...
Current production version: **v3.4.7**
...
- Softened the in-app brand mark into a rounder squircle and reduced the centered “L” to add clear, balanced padding, while keeping the install artwork full-bleed for native iOS masking.
